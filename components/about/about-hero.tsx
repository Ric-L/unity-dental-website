      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-primary/20 mb-4">
            ...
            <span className="text-sm text-foreground">About Unity Dental</span>
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-tight text-balance">
            Excellence in <span className="gold-text-gradient">Dental Care</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            For over 15 years, Unity Dental Clinic has been transforming smiles and changing lives with compassionate,
