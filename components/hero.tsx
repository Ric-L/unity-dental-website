    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Section */}
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="space-y-8 text-center lg:text-left">
            {/* Tagline */}
            <motion.div
            ...
            >
              ...
              <span className="relative inline-block">
                Our Passion
                <motion.span className="absolute -bottom-2 left-0 w-full h-1 blue-gradient" initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ duration: 1, delay: 0.8 }} />
              </span>
            </motion.h1>
            ...
            >
              Experience world-class dental care with cutting-edge technology and a team dedicated to creating beautiful, healthy smiles that last a lifetime.
            </motion.p>
