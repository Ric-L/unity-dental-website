      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-tight text-balance">
            Comprehensive <span className="gold-text-gradient">Dental Solutions</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            From preventive care to advanced procedures, we offer a complete range of dental services tailored to your
            unique needs.
          </p>
        </motion.div>
      </div>
